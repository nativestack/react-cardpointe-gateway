...
export default class CardPointeTokenizer extends Component {
	...
	renderTokenizerUi() {
		...
		const cssStyle =
			'css=.error{color:red;border-color:red;}label{font-family:sans-serif;font-size:10px;}input{height:18px;font-size:22px;}body{margin:0px;height:100%}select{height:18px;}'
